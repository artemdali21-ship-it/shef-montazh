...
export function BottomNav({ userType, userId }: BottomNavProps) {
  ...
  return (
    ...
    >
      <div className="max-w-screen-md mx-auto h-full flex items-center justify-around px-2 py-2">
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className="flex flex-col items-center justify-center gap-0.5 min-w-[64px] px-2 py-2 transition-colors duration-200"
            >
