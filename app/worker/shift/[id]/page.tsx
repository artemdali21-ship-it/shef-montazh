...
import {
  ...
  Briefcase, User, CheckCircle, Wrench, Shield, Phone
} from 'lucide-react'
...
import DownloadActButton from '@/components/documents/DownloadActButton'
...
export default function WorkerShiftDetailPage() {
  ...
  return (
    ...
    >
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 text-sm">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-gray-300">{client.rating.toFixed(1)}</span>
                  </div>
                  <span className="text-gray-400">•</span>
                  <span className="text-gray-400">{client.total_shifts} смен</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Completed Shift - Download Act */}
      {shift.status === 'completed' && workerStatus === 'completed' && client && (
        <div className="fixed bottom-20 left-0 right-0 p-4 bg-[#2A2A2A]/95 backdrop-blur-xl border-t border-white/10 max-w-screen-md mx-auto z-40">
          <div className="space-y-3">
            <div className="w-full py-3 bg-green-500/20 border border-green-500/30 rounded-xl text-green-400 font-bold text-center flex items-center justify-center gap-2">
            ...
            <DownloadActButton
              ...
              workerName="Имя работника" // TODO: Get from auth context
      ...
      {workerStatus === 'checked_in' && shift.status !== 'completed' && (
        <div className="fixed bottom-20 left-0 right-0 p-4 bg-[#2A2A2A]/95 backdrop-blur-xl border-t border-white/10 max-w-screen-md mx-auto z-40">
