...
export default function ClientDashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#2A2A2A] to-[#1A1A1A] pb-24">
      ...
      <button
        onClick={() => router.push('/shifts/create')}
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 rounded-full shadow-2xl shadow-orange-500/50 flex items-center justify-center transition-transform hover:scale-110 z-50"
      >
