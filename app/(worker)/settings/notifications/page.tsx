        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 overflow-hidden">
          ...
          <div className="divide-y divide-white/10">
            ...
            <div className="p-4 flex items-center justify-between">
              <div>
                <p className="text-white font-medium mb-0.5">Новые смены в районе</p>
                <p className="text-xs text-gray-400">Когда появляется смена в вашем районе</p>
              </div>
              <button
                onClick={() => handleToggle('new_shifts')}
                className={`relative w-12 h-7 rounded-full transition ${
                  settings.new_shifts ? 'bg-orange-500' : 'bg-white/10'
                }`}
              >
                <div
                  className={`absolute top-1 w-5 h-5 bg-white rounded-full transition-transform ${
                    settings.new_shifts ? 'translate-x-6' : 'translate-x-1'
                  }`}
                />
              </button>
            </div>
            ...
            <div className="p-4 flex items-center justify-between">
              <div>
                <p className="text-white font-medium mb-0.5">Одобрение откликов</p>
                <p className="text-xs text-gray-400">Когда ваш отклик одобрен заказчиком</p>
              </div>
              <button
            ...
            <div className="p-4 flex items-center justify-between">
              <div>
                <p className="text-white font-medium mb-0.5">Уведомления об оплате</p>
                <p className="text-xs text-gray-400">Когда вам начислена оплата</p>
              </div>
              <button
