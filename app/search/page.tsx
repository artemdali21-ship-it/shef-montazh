...
import { Search, Filter, ChevronDown, X, MapPin, Calendar, DollarSign, ShieldCheck, Clock, Inbox } from 'lucide-react'
...
export default function SearchPage() {
  ...
  return (
    ...
    >
      {/* HEADER */}
      <Header title="Поиск смен" showBack={false} showNotifications={true} />
